...
import { MDBDataTableV5, MDBNavbar, MDBNavbarBrand, MDBNavbarNav, MDBNavItem, MDBNavLink, MDBNavbarToggler, MDBCollapse, MDBDropdown,
...
export const TableSeminar = (props) => {
    ...
    //delete all data
    const DeleteAll = () => {
        axios.post('/delete-all', { admin:false }).then((res) => {
